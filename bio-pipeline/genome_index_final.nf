...
// 🧬 Final Genome Indexing Pipeline
...
process index_genome {
    ...
    # Descomprimir con bgzip (mantiene compatibilidad con samtools)
    echo "🔧 Decompressing with bgzip..."
    bgzip -d -c "${params.output_dir}/${genome_id}.fa.gz" > "${params.output_dir}/${genome_id}.fa"
    
    # Volver a comprimir con bgzip (para índice FAI)
    echo "🔧 Re-compressing with bgzip for indexing..."
    bgzip "${params.output_dir}/${genome_id}.fa"
    
    # Step 1: FASTA index (ahora funciona con bgzip)
